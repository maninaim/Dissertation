...
FLAGSP= -I/home/damzsay/Thesis/mmndissertation/Healpix_3.30/src/cxx/generic_gcc/include/
GPP = g++
TARGETP = master
SOURCEP = master_main.cc
LIBSP= -L/home/damzsay/Thesis/mmndissertation/Healpix_3.30/src/cxx/generic_gcc/lib -lhealpix_cxx -lcxxsupport -lsharp -lc_utils -lfftpack -lcfitsio -fopenmp
MYLIBSP=-I//home/damzsay/Thesis/mmndissertation/MASTER/include -I//home/damzsay/Thesis/mmndissertation/MASTER/bin
...
pow_spec:
	$(GPP) -o $(TARGETP) $(FLAGSP) $(MYLIBSP) $(SOURCEP) $(LIBSP)
clean:
	rm $(TARGET)
	touch *
